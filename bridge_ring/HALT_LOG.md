...
**Routing:** If a halt is triggered during cross-instance messaging, log it here. Optionally mirror a summary entry in `continuity_ring/HALT_LOG.md` for Autonomy Benchmark aggregation.
