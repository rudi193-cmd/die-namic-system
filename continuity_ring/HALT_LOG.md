...
**Routing:** This is the primary ledger for Autonomy Benchmark scoring. Ring-specific HALT_LOGs (bridge_ring, source_ring) may mirror summary entries here for aggregation.
